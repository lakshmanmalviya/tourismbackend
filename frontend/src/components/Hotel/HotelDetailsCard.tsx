...
import { FaChevronDown, FaChevronUp, FaStar, FaLaptop, FaPhone } from "react-icons/fa";
      ...
      >
        ...
        >
          ...
          <div className="bg-white rounded-lg shadow-lg border border-gray-200 p-6">
            ...
            <div>
              <h1 className="text-sm text-gray-600 flex items-center">
                <MdEventAvailable className="text-red-500 mr-2" /> {availableRooms} Available Rooms
              </h1>
            </div>
